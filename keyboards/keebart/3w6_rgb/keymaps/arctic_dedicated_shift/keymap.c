...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ALPHA_QWERTY] = LAYOUT_split_3x5_3(
        ...
        DE_Z, DE_X, DE_C, DE_V, DE_B,                                    DE_N, DE_M, DE_ADIA, DE_UDIA, DE_ODIA,
        LSFT_T(KC_ENT) , LT(_SYM, KC_SPC), LT(_NAV,  KC_BSPC),          LT(_NUM, KC_BSPC), LSFT_T(KC_ENT) , LT(_FUN, KC_TAB)
    ),
    
    [_SYM] = LAYOUT_split_3x5_3(
        DE_TILD , DE_PIPE , DE_EQL        , DE_LCBR , DE_RCBR ,               DE_PERC , DE_QUES, DE_DQUO       , DE_QUOT     , DE_ACUT       ,
        DE_RABK , DE_SLSH , LSFT(DE_PLUS) , DE_LPRN , DE_RPRN ,               DE_HASH , DE_EXLM, LSFT(DE_COMM) , LSFT(DE_DOT),  LSFT(DE_MINS),
        DE_LABK , DE_BSLS , DE_PLUS       , DE_LBRC , DE_RBRC ,               DE_AT   , DE_AMPR, DE_COMM       , DE_DOT      , DE_MINS       ,
